            ...
            <table cellspacing="0" cellpadding="0" border="1">
                ...
                <tbody>
                    <tr v-for="(item, index) in info.items" :key="index">
                        ...
                        <td v-if="!info.datas[index].length && !info.closed"></td>
                    </tr>
                    <tr>
                        <td>净资产</td>
                        <td v-for="(time, index) in info.times" :key="index">{{ getFullAmount(index) }}</td>
                        <td v-if="!info.times.length && !info.closed"></td>
                    </tr>
                    <tr v-if="!info.closed">
    ...
    export default{
        ...
        methods:{
            ...
            changeData: function(x,y,data){
                if(this.info.closed){
                    this.$message.error('此账簿已关闭，无法修改');
                    return;
                }
